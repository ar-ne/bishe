...
export class UserControllerApi {
     ...
     * @param authorization 
     */
    public async userControllerUserinfo (authorization?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: UserInfo;  }> {
